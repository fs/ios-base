...
// FSHelper
#define COCOAPODS_POD_AVAILABLE_FSHelper
#define COCOAPODS_VERSION_MAJOR_FSHelper 1
#define COCOAPODS_VERSION_MINOR_FSHelper 0
#define COCOAPODS_VERSION_PATCH_FSHelper 1
